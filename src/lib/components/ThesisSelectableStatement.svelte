...
<Card padded style="flex-direction: row;">
	<Card variant="outlined" padded>{statement.text}</Card>
	<NegativeButton onclick={onContraSelected} title="Select As Opposed Thesis" />
	<PositiveButton onclick={onProSelected} title="Select As Supported Thesis" />
</Card>
